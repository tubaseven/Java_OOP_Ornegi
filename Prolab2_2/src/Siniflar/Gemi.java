...
public class Gemi extends DenizTasiti {

    public Gemi() {
    }

    public Gemi(String renk, String marka, int uretimYili, int hiz, int tekerlekSayisi, int fiyat) {
...
//        setTekerlekSayisi( Integer.parseInt(giris.nextLine()));
        ...
        String yazilacakVeri = getID() + "-Arac Tipi: Gemi, " + "Marka: " + getMarka() + ", Uretim Yılı: " + getUretimYili() + ", Renk: " + getRenk() + ", Hiz: " + getHiz() + ", Tekerlek Sayisi: " + getTekerlekSayisi() + ", Fiyat: " + getFiyat();
        ...
        try {
            ...
            System.out.println("\nHATA: Gemi Eklenemedi: " + e.getMessage());
        }
    }
...
//        setTekerlekSayisi( Integer.parseInt(giris.nextLine()));
        ...
        try {
            ...
            System.out.println("\nHATA: Gemi Guncellenemedi: " + e.getMessage());
        }
    }
    ...
    public void Listele() {
        try {
            ...
            ArrayList<String> araclar = DosyaIslemleri.Arac_Listele("Gemi");
